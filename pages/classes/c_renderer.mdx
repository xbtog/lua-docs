...
| --------- | ---------------------------- | -------- |
| start_pos | [`vec2`](/structs/math/vec2) | +        |
| end_pos   | [`vec2`](/structs/math/vec2) | +        |
...
| Argument  | Type                         | Required |
| --------- | ---------------------------- | -------- |
| start_pos | [`vec3`](/structs/math/vec3) | +        |
| end_pos   | [`vec3`](/structs/math/vec3) | +        |
| color     | [`color`](/structs/color)    | +        |
| thickness | `number`                     | +        |
...
| Argument  | Type                         | Required |
| --------- | ---------------------------- | -------- |
| start     | [`vec2`](/structs/math/vec2) | +        |
| size      | [`vec2`](/structs/math/vec2) | +        |
| color     | [`color`](/structs/color)    | +        |
| rounding  | `number`                     | +        |
| thickness | `number`                     | +        |
...
| Argument  | Type                         | Required |
| --------- | ---------------------------- | -------- |
| left      | [`vec2`](/structs/math/vec2) | +        |
| right     | [`vec2`](/structs/math/vec2) | +        |
| bottom    | [`vec2`](/structs/math/vec2) | +        |
| color     | [`color`](/structs/color)    | +        |
| thickness | `number`                     | +        |
